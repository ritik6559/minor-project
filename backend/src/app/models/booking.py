...
class RoomBooking(Base):
    ...
    student_coordinator: Mapped["User"] = relationship("User", foreign_keys=[student_coordinator_id])
    faculty_supervisor: Mapped["User"] = relationship("User", foreign_keys=[faculty_supervisor_id])
